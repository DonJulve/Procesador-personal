...
static unsigned long jubiladas = 0, agnadida = 0;
    ...
    do
    {
        ...
        if(carga_D){
            ...
            if (agnadida == -1) {
                ...
                if(etapa_Din.cd0){
                    //En caso de escribir en el BR se necesita 1 ciclo extra
                    ROBejecuta(agnadida, tiempo + latenciasWR[etapa_Din.co] + 2); 
                }
                else{
                    ROBejecuta(agnadida, tiempo + latenciasWR[etapa_Din.co] + 1);
                }      
                //Siempre hay que dar 1 ciclo extra para poder jubilar las instrucciones          
            }    
        }
